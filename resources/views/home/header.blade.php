<nav class="navbar navbar-expand-lg navbar-light shadow">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <a class="navbar-brand text-success logo h1 align-self-zcenter" href="{{url('/')}}">
            ShopFusion
        </a>
        ...
        <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
            <div class="flex-fill">
                <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('user/shop')}}">Shop</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('user/contact')}}">Contact</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('user/my_order') }}">My Orders</a>
                    </li>
                </ul>
            </div>
            <div class="navbar align-self-center d-flex">
                ...
                <a class="nav-icon position-relative text-decoration-none" href="{{url('user/my_cart')}}">
                ...
                @if (Route::has('login') && Auth::check())
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        ...
                        <button class="btn btn-danger"> 
                            <i class="fa fa-fw fa-sign-out-alt text-dark mr-1 text-white"></i>
                            Logout
                        </button>    
                    </form>
