                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="product_title" class="form-control" id="basic-default-fullname" placeholder="Enter Product Title">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-fullname">Product Description</label>
                                    <textarea name="product_desc" class="form-control" id="basic-default-fullname" placeholder="Enter Product Description"></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="product_price" class="form-control" id="basic-default-fullname" placeholder="Enter Product Price">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-fullname">Product Quantity</label>
                                    <input type="number" name="product_quantity" class="form-control" id="basic-default-fullname" placeholder="Enter Product Quantity">
                                </div>
